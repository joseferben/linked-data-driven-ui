...
\begin{table}[!htb]
  \begin{center}
    \begin{tabular}{|l|l|l|}
      ...
      \hline
    \end{tabular}
    \caption{The result of the risk analysis shows the list of all risks sorted descending by their total risk factor. R1 and R6 might have a large impact on design goals and decisions.}
