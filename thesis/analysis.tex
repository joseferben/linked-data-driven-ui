...
\begin{table}[!htb]
  \begin{center}
    \begin{tabular}{|l|l|}
      ...
      \textbf{Risk Factor} & 8 \\
      \hline
      \textbf{Description} & \begin{tabular}[x]{@{}l@{}}The used HATEOAS specification is either an early draft or it has been \\ abandoned. In the worst case the specification superficially appears \\ to be complete while not providing crucial features that are needed by \\ the use cases. Parts of it have to be written during the thesis work.\end{tabular} \\
      \hline
    \end{tabular}
...
\begin{table}[!htb]
  \begin{center}
    \begin{tabular}{|l|l|}
      ...
      \textbf{Risk Factor} & 3 \\
      \hline
      \textbf{Description} & \begin{tabular}[x]{@{}l@{}}The used HATEOAS specification and reference implementations are \\ under development and parts are rewritten frequently. For the thesis \\ work a version has to be pinpointed.\end{tabular} \\
      \hline
    \end{tabular}
...
\begin{table}[!htb]
  \begin{center}
    \begin{tabular}{|l|l|}
      ...
      \textbf{Risk Factor} & 4 \\
      \hline
      \textbf{Description} & \begin{tabular}[x]{@{}l@{}}The used HATEOAS specification has no reference implementation, \\ little working examples and no tools for generating and consuming \\ HATEOAS APIs. All tools have to be written from scratch.\end{tabular} \\
      \hline
    \end{tabular}
...
\begin{table}[!htb]
  \begin{center}
    \begin{tabular}{|l|l|}
      ...
      \hline
      \textbf{Occurrence} Probability & 1 \\
      \hline
      \textbf{Severity} & 3 \\
      \hline
      \textbf{Risk Factor} & 3 \\
