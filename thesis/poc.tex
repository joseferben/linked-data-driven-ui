...
The domain renderers are provided by the UI developers. They contain domain knowledge and can only render specific data types. As discussed in section \ref{problem}, contemporary clients and their UIs are tightly coupled to HTTP APIs. \\
