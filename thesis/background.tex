...
\lstset{language=XML}
\begin{lstlisting}[caption=Level 0: \gls{remoteprocedurecall} on HTTP. \citep{richardsonmaturitymodel}]
...
This thesis aims to specify \gls{hateoas} in order to allow a generic UI to consume any API that conforms to this specification. A generic UI consumes that machine readable API and allows users to interact with it.
