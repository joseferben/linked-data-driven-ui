...
\begin{itemize}
\item a hypermedia vocabulary and \gls{hateoas} specification
...
\end{itemize}
The choice of the \gls{hateoas} specification is driven by the implementation of the HTTP APIs. The development of the HTTP APIs is driven by use cases that resemble real world scenarios. The UI framework is used to create a client that can consume both HTTP APIs which conform to that HATEOAS specification.
...
\subsection{\gls{hateoas} API specifications}
