...
By using \textbf{linked data} the use of custom renderers doesn't hurt the reusability of the client. Linked data always provides a context so it can be understood by machines. That context is not hard coded in the client unlike how it is done in contemporary UI development - especially with SPAs. \\
